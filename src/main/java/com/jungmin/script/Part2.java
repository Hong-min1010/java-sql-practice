...
public class Part2 {
  ...
  */
  public static final String PART2_3 = "INSERT INTO Users (username, email, password)" +
          "VALUES ('나', 'qza7367@gmail.com', '123')";
  ...
  */
  public static final String PART2_9 = "UPDATE posts set posts.content = 'Updated content' where posts.title = 'New Tech Trends'";
  ...
  */
  public static final String PART2_10 = "INSERT INTO posts (user_id, title, content) VALUES(1, '제목', '내용')";
  ...
  */
  public static final String PART2_12 = "select p.title from posts as p where user_id = 1";

  /*
  ----------------------------------------------------------------------------------------------
      TODO: Q 2-13. users 테이블의 user_id가 1인 유저가 작성한 post의 board name을 찾기위한 SQL을 작성해주세요.
  */
  public static final String PART2_13 = "select b.name from boards as b join posts as p on p.board_id = b.board_id where p.user_id = 1";

  /*
  ----------------------------------------------------------------------------------------------
      TODO: Q 2-14. board의 name이 'General Discussion'인 post의 title, content, created_at을 찾기위한 SQL을 작성해주세요.
  */
  public static final String PART2_14 = "select p.title, p.content, p.created_at " +
          "from posts as p " +
  ...
  */
  public static final String PART2_15 = "select count(c.comment_id) as CommentCount from comments as c join users as u on u.user_id = c.user_id where u.username = 'luckykim'";
  ...
  */
  public static final String PART2_16 = "select u.username, count(comment_id) as CommentCount from comments as c " +
  ...
  */
  ...
  public static final String PART2_17 = "select b.name, count(p.board_id) as PostCount from posts as p " +
          "join boards as b on b.board_id = p.board_id " +
          "group by p.post_id";
  ...
  */
  public static final String PART2_18 = "select b.name, AVG(LENGTH(p.content)) as AvgLength from posts as p " +
          "left join boards as b on b.board_id = p.board_id " +
          "group by p.post_id";
  ...
  */
  public static final String PART2_20 =
          "select t.name, count(pt.post_id) as PostCount " +
          "from tags as t " +
